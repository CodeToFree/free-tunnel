...
const chains = TESTNET
  ...
  : { eth, arb, bnb, polygon, avax, base, linea, scroll, mode, manta, zklink, core, xlayer, mantle, merlin, b2, bitlayer, bevm, bb, bob, opbnb, kava, kroma, klaytn, ailayer, zircuit, iotex, zeta, taiko, sei, duck }
