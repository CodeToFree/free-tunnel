...
export default function TokenIcon ({ size, token, className }) {
  ...
  if (token === 'eth' || token === 'beth') {
  ...
  } else if (token?.includes('xsolvbtc')) {
    return <img src='/tokens/xsolvbtc.png' className={_className} />
    ...
    return <img src='/tokens/pump.png' className={_className} />
  } else if (token === 'ubtc') {
    ...
    return <img src='/tokens/sonic.png' className={_className} />
  } else if (token === 'cfx') {
    return <img src='/tokens/cfx.png' className={_className} />
  } else if (token === 'neox') {
    return <img src='/tokens/neox.png' className={_className} />
  } else if (token === 'soneium') {
    return <img src='/tokens/soneium.png' className={_className} />
  } else if (token === 'kava') {
    ...
    return <img src='/tokens/exsat.png' className={_className} />
  } else if (token === 'hemi') {
