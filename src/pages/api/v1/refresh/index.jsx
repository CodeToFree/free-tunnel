...
const events = {
  ...
  '0x50b4e60af041aafbb7c9d87342fcb375330b69151dfbfe74ba4d0bfc87d16839': 'TokenMintCancelled',
...
async function post(req, res) {
  ...
  await Promise.all(tunnels.map(tunnel => Promise.all([...tunnel.from, ...tunnel.to].map(id => refresh(id, tunnel).catch(console.warn)))))
  
  res.json({ result: true })
}

export async function refresh(id, tunnel) {
